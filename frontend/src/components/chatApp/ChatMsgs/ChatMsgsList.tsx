...
import Msg from "./Msg"
import { IMember, IMsg } from "../../../types"

export default function ChatMsgList({ msgs, msgLoding, chatMembersInfo, chatMsgListRef, chatListPrevHeightRef, chatListTopElemRef, chatListUpdateTypeRef }: {
  msgs: IMsg[]
  msgLoding: boolean
  ...
  return (
    <div ref={chatMsgListContainerRef} className="h-full bg-white px-5  overflow-y-auto">
      <div ref={chatListTopElemRef}></div>
      {
        msgLoding &&
        <div className="flex w-full justify-center py-2">
          <div role="status">
            <svg aria-hidden="true" className="w-12 aspect-square text-cyan-900 animate-spin fill-cyan-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div
        ...
        className="flex flex-col space-y-5 my-5">
        {
          msgs.map((msg) => {
            ...
            return (
              <Msg key={msg._id} msg={msg} name={name} />
            )
          })
        }
      </div>
